...
helper_sqrt_f16 \
helper_dc_zva \
helper_alignment_fault_exception \
helper_sp_alignment_exception \
read_raw_cp_reg \
write_raw_cp_reg \
pmu_init \
pmu_op_start \
...
helper_uc_hooksys64 \
cheri_tcg_save_pc \
cheri_tcg_prepare_for_unconditional_exception \
aarch_cpu_get_tb_cpu_state \
clean_data_tbi \
"
...
ARCHS="x86_64 arm aarch64 morello riscv32 riscv64 mips mipsel mips64 mips64el sparc sparc64 m68k ppc ppc64 s390x tricore"
